    ...
    public partial class Add : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false, comment: "The id of the event")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ...
                    OrganiserId = table.Column<string>(type: "nvarchar(450)", nullable: false, comment: "The organizers' id"),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "The creation date and time of the event"),
                    Start = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "The start date and time of the event"),
                    End = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "The end date and time of the event"),
                    TypeId = table.Column<int>(type: "int", nullable: false, comment: "The types' id")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    HelperId = table.Column<string>(type: "nvarchar(450)", nullable: false, comment: "The id of the participant"),
                    EventId = table.Column<int>(type: "int", nullable: false, comment: "The id of the event")
                },
                constraints: table =>
                {
